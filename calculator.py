...
f =Frame(root,bg="grey")
b=Button(f,text="0",padx=31,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="-",padx=31,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)
...
f =Frame(root,bg="grey")
b=Button(f,text="/",padx=33,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="+",padx=21,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="=",padx=27,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)
...
f =Frame(root,bg="grey")
b=Button(f,text="C",padx=26,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text=".",padx=26,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)

b=Button(f,text="00",padx=26,pady=18,font="lucida 25 bold")
b.pack(side=LEFT,padx=18,pady=5)
b.bind("<Button-1>",click)
